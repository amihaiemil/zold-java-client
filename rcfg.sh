...
sed -i "s/<a.*>fat<\/a>/<a href=\"https:\/\/oss\.sonatype\.org\/service\/local\/repositories\/releases\/content\/com\/amihaiemil\/web\/zold-java-client\/${tag}\/zold-java-client-${tag}-jar-with-dependencies\.jar\">fat<\/a>/" README.md
